...
"""
STAGE 1: BUILD POD BASIS FOR POD-RBF

This stage only builds the POD basis and stores artifacts needed by later stages.
It does not run RBF training and does not run final reconstruction tests.

Outputs (inside POD-RBF):
  - basis.npy
  - sigma.npy
  - u_ref.npy
...
def main(
    ...
    print("\n====================================================")
    print("         STAGE 1: POD BASIS FOR POD-RBF")
    print("====================================================")
