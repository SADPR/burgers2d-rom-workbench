...
def main(
    ...
    print("\n====================================================")
    print("         STAGE 1: POD BASIS FOR POD-DL")
    print("====================================================")
        ...
        [
            ...
            (
                ...
                [
                    ...
                    ("n_available", int(info.get("n_available", sigma.size))),
                    ("energy_lost", float(info["energy_lost"])),
                    ("energy_captured", float(info["energy_captured"])),
                    ("centered", bool(info.get("centered", center))),
                    ("reference_source", info.get("reference_source", None)),
                ],
            ),
            (
                "timings_seconds",
                [
                    ("snapshot_aggregation", elapsed_snapshots),
                    ("pod_compute", elapsed_pod),
                ],
            ),
            (
                "outputs",
