...
\graphicspath{{Figures/}{/home/sares/Documents/HGV2/figures/}{/home/sares/Documents/HGV2/figures/validation_final_rbf363/}{/home/sares/Documents/HGV2/figures/validation_final_rbf363/error_maps/}{/home/sares/Documents/HGV2/figures/validation_final_rbf363/coefficients/}}
...
\addlinespace[0.35em]
HPROM & 96 & -- & 4\,824 & 1.030 & 1.096 & 0.905 & 13.8 \\
HQPROM & 39 & -- & 3\,505 & 0.871 & 0.933 & 0.967 & 12.9 \\
HPROM-GPR & 20 & 131 & 1\,801 & 0.691 & 0.845 & 0.407 & 30.8 \\
\addlinespace[0.35em]
Local HPROM ($N_c=3$) & 35--48 & -- & 3\,405 & 0.897 & 0.933 & 0.364 & 34.4 \\
Local HQPROM ($N_c=3$) & 21--27 & -- & 2\,152 & 0.888 & 1.025 & 0.504 & 24.8 \\
Local HPROM-GPR ($N_c=3$) & 9 & 60--97 & 811 & 0.714 & 0.786 & 0.284 & 44.1 \\
\addlinespace[0.35em]
Local HPROM ($N_c=5$) & 23--31 & -- & 2\,384 & 0.915 & 0.943 & 0.265 & 47.3 \\
Local HQPROM ($N_c=5$) & 15--20 & -- & 1\,593 & 0.760 & 0.878 & 0.380 & 33.0 \\
Local HPROM-GPR ($N_c=5$) & 7 & 41--68 & 631 & 0.673 & 0.880 & 0.251 & 49.8 \\
\addlinespace[0.35em]
Local HPROM ($N_c=8$) & 16--26 & -- & 1\,781 & 0.787 & 0.900 & 0.220 & 56.9 \\
Local HQPROM ($N_c=8$) & 10--15 & -- & 1\,075 & 0.787 & 0.890 & 0.296 & 42.3 \\
Local HPROM-GPR ($N_c=8$) & 6 & 28--54 & 541 & 0.801 & 1.156 & 0.243 & 51.4 \\
\hline
\end{tabular}}
\vspace{0.2em}
...
\begin{itemize}
  \item All local ROMs improve runtime performance relative to their global counterparts, at every $N_c$ and at matched accuracy: $13.8\times\!\to\!56.9\times$ (HPROM), $12.9\times\!\to\!42.3\times$ (HQPROM), $30.8\times\!\to\!51.4\times$ (HPROM--GPR).
  \item Increasing $N_c$ monotonically improves speedup within every family, so clustering, not the choice of local manifold, is the dominant lever.
  \item Local HPROM at $N_c=8$ is the fastest model: 0.220 min and $56.9\times$ speedup.
  \item Compactness and wall-clock time rank differently. At $N_c=8$, HPROM--GPR is the most compact ($n=6$, $N_e=541$) and HQPROM next ($n=10$--$15$, $N_e=1{,}075$), yet plain HPROM is fastest despite $n=16$--$26$: the per-iteration cost of the quadratic term and its Jacobian, and of the GPR evaluation, offsets their dimensional advantage.
...
\tiny
\resizebox{\textwidth}{!}{%
\begin{tabular}{lccrrr|rr|rr}
\toprule
\textbf{Model} & $n$ & $\bar n$ & $C_D$ [\%] & $C_L$ [\%] & $C_M$ [\%] & \multicolumn{2}{c|}{\textbf{Online time [s]}} & \multicolumn{2}{c}{\textbf{Speedup}} \\
...
Global HPROM--RBF & 8 & 354 & 1.388 & 1.335 & 7.004 & 6.00 & 1.15 & 4.00 & 20.97 \\
Local HPROM--RBF, $N_c=4$ & 8 & 117--140 & 1.978 & 2.183 & 7.117 & \textbf{2.28} & \textbf{0.62} & \textbf{10.54} & \textbf{38.88} \\
\bottomrule
\end{tabular}}

\vspace{0.15cm}
\footnotesize \texttt{True}/\texttt{False} denotes \texttt{IncludeAllLiftDragFaces}. For linear HPROM, $n$ is the full POD rank. For RBF, $n$ and $\bar n$ are the primary and secondary dimensions; local $\bar n$ values are ranges across the four cluster bases. Each speedup is relative to global linear HPROM with \texttt{True}.

\vspace{0.08cm}
\footnotesize The RBF \texttt{False} runs omit the postprocessing-only lift/drag faces and their $C_L$, $C_D$, $C_M$ output. The accuracy entries come from the matching \texttt{True} runs. All timing values are means of the maximum-rank \emph{Nonlinear ROM Online} timer over validation cases 000--009.
\end{frame}
