...
"""
STAGE 1: CLUSTER FULL SNAPSHOTS [u; v] FOR LOCAL POD-GPR
...
def plot_cluster_sizes(primary_sizes, overlap_sizes, out_png):
    ...
    plt.title("Local POD-GPR Stage1 cluster sizes")
    plt.xticks(xs)
...
def main(
    ...
    phi=0.1,
    time_subsample=1,
    output_file=os.path.join(script_dir, "local_gpr_clusters_full.npz"),
