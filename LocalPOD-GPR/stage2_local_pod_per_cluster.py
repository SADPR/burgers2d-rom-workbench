...
"""
STAGE 2: LOCAL POD PER CLUSTER (LOCAL POD-GPR)

Inputs (from stage1):
  - local_gpr_clusters_full.npz
...
def plot_cluster_ranks(r_list, out_png):
    ...
    plt.title("Local POD-GPR Stage2 retained rank per cluster")
    plt.xticks(xs)
...
def main(
    ...
    for _path in (output_file, rank_plot_file, summary_file):
        _dir = os.path.dirname(_path)
        if _dir:
            os.makedirs(_dir, exist_ok=True)

    print("\n====================================================")
    print("     STAGE 2: LOCAL POD-GPR POD PER CLUSTER")
    print("====================================================")
