...
"""Maday-isolated wrapper for full data-driven sparse-GPR trainer (qN = G(mu,t))."""
...
def main(argv=None):
    ...
    import stage3_perform_training_rom_data_driven_sparse_gpr as base
    ...
    print(f"[MADAY-STAGE3-DD-SPARSE-GPR] tag={paths.tag}")
    print(f"[MADAY-STAGE3-DD-SPARSE-GPR] stage3_dir={paths.stage3}")
    print(f"[MADAY-STAGE3-DD-SPARSE-GPR] models_dir={paths.stage3_models}")
