...
"""Isolated wrapper for Case-3 ANN training in paper/Maday campaigns."""
...
def main(argv=None):
    ...
    import stage3_perform_training_case_3_ann as base
    ...
    print(f"[MADAY-STAGE3-CASE3-ANN] tag={paths.tag}")
    print(f"[MADAY-STAGE3-CASE3-ANN] stage3_dir={paths.stage3}")
    print(f"[MADAY-STAGE3-CASE3-ANN] models_dir={paths.stage3_models}")
