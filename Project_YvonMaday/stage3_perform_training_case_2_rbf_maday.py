...
"""Maday-isolated wrapper for Case-2 RBF trainer.
...
def main(argv=None):
    ...
    import stage3_perform_training_case_2_rbf as base
    ...
    if "--summary-name" not in passthrough:
        passthrough.extend(["--summary-name", f"case2_training_summary_rbf__{paths.tag}.txt"])

    print(f"[MADAY-STAGE3-RBF] tag={paths.tag}")
    print(f"[MADAY-STAGE3-RBF] stage3_dir={paths.stage3}")
    print(f"[MADAY-STAGE3-RBF] models_dir={paths.stage3_models}")
