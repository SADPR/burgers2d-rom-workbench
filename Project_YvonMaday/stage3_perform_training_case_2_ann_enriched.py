...
def load_prom_dataset_case2(dataset_root: str):
    """
...
def main():
    ...
    model_path = os.path.join(stage3_models_dir, "case2_model_enriched.pt")
    ...
    # Load data
    # -----------------------------
    X_raw, Y_raw = load_prom_dataset_case2(dataset_root)
