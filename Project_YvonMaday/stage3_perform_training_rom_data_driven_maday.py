...
"""Maday-isolated wrapper for full data-driven ANN trainer (qN = G(mu,t))."""
...
def main(argv=None):
    ...
    import stage3_perform_training_rom_data_driven as base
    ...
    print(f"[MADAY-STAGE3-DD-ANN] tag={paths.tag}")
    print(f"[MADAY-STAGE3-DD-ANN] stage3_dir={paths.stage3}")
    print(f"[MADAY-STAGE3-DD-ANN] models_dir={paths.stage3_models}")
